...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        // Menyiapkan SQL query untuk menambahkan pasien
        $sql = "INSERT INTO pasien (nama, nik, tanggal_lahir, jenis_kelamin, alamat, telepon, user_id) 
                VALUES (:nama, :nik, :tanggal_lahir, :jenis_kelamin, :alamat, :telepon, $id_terakhir)";
        $stmt1 = $conn->prepare($sql);

        // Binding parameters
        $stmt1->bindParam(':nama', $nama);
        $stmt1->bindParam(':nik', $nik);
        $stmt1->bindParam(':tanggal_lahir', $tanggal_lahir);
        $stmt1->bindParam(':jenis_kelamin', $jenis_kelamin);
...
<!-- <form method="POST">
    ...
    <input type="hidden" name="role" value="pasien"><br>
